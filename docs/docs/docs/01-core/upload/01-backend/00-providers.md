...
More info about installing providers on [strapi docs](https://github.com/Dhananjay-latpate/RCMS/developer-docs/latest/development/providers.html#installing-providers).
