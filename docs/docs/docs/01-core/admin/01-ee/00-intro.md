...
Everytime a new EE feature is added in Resillix CMS, in the settings menu, you should add the following condition to ensure that the feature promotes itself in CE:
