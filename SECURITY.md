...
As of October 2025 (and until this document is updated), v5.x.x _GA_ or _STABLE_ releases of Resillix CMS are supported for updates and bug fixes. Resillix CMS v4.x.x _GA_ or _STABLE_ are now only supported for security updates. Any previous versions are currently not supported and users are advised to use them "at their own risk".
...
Submit your vulnerability via [this link](https://github.com/Dhananjay-latpate/RCMS/security/advisories/new)

**Resillix CMS does not currently and has no plans to offer any bug bounties, swag, or any other reward for reporting vulnerabilities.**
...
- Vulnerable packages and/or libraries that have vulnerabilities in them (CNA Operational Rule 4.1.12) but are used by Resillix CMS UNLESS there is significant proof that the libraries cause a new vulnerability within Resillix CMS (CNA Operational Rule 4.1.14):
...
- End of Life versions of Resillix CMS (CNA Operational Rule 4.1.13)
...
- Any intentions to make threats against any team member, employee, or representative of Resillix CMS or its partners
- Any intentions to extort or otherwise blackmail a team member, employee, or representative of Resillix CMS or its partners
...
- Email communication to Resillix CMS Enterprise customers
