import { useRBAC, useQueryParams } from '@resillix/admin/strapi-admin';
import { unstable_useDocumentLayout as useDocumentLayout } from '@resillix/content-manager/strapi-admin';
...
import type { PanelComponent, PanelComponentProps } from '@resillix/content-manager/strapi-admin';
